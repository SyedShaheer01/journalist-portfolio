...
const LoginModal = () => {
  ...
  if(currstate === "Signup"){
    try {
      await axios.post("https://journalist-portfolio-backend.vercel.app/user/signup",data)
      .then(res=>{
    ...
    axios.post("https://journalist-portfolio-backend.vercel.app/user/login",data)
    .then(res=>{
      console.log(res)
      setSpinner(false)
      setToken(res.data.token)
