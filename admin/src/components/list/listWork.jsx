...
function ListWork() {
  ...
  // Fetch products
  useEffect(() => {
    axios.get("https://journalist-portfolio-backend.vercel.app/api/copywriting/list")
      .then(res => {
  ...
  const deleteProduct = (id) => {
    axios.post("https://journalist-portfolio-backend.vercel.app/api/copywriting/remove", { id })
      .then(res => {
        Swal.fire({
